  ...
  router.post('/', (req, res, next) => {
    ...
    if(req.body!=undefined){
      ...
      if (title == undefined && month === undefined && year == undefined && authors == undefined && venue == undefined ){
        ...
        else res.status(500).json({ errors: ['PUB_CREATE_ERROR'] })
      }
        ...
        else res.status(400).json({ errors: ['PUB_AT_LEAST_5_CHAR_FORM'] })
      }
        ...
        else res.status(400).json({ errors: ['MONTH_ERROR_FORM'] })
      }
        ...
        else res.status(400).json({ errors: ['YEAR_NOT_INT_FORM'] })
      }
        ...
        else res.status(400).json({ errors: ['VENUE_AT_LEAST_5_CHAR_FORM'] })
      }
        ...
        else res.status(400).json({ errors: ['AUTHOR_EMPTY_FORM'] })
      }
